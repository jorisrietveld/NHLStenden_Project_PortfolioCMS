...
{
    /**
     * The request that the application will handle.
     *
     * @var Request
     */
    protected $request;
    ...
    /**
     * The response generated by the output of the request.
     *
     * @var Response
     */
    protected $response;
    ...
    /**
     * The configuration loader for loading configuration configured in ../../config/config.xml
     *
     * @var ConfigLoader
     */
