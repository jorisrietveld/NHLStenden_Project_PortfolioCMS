...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?= $dataProvider->get("request-uri") ?>assets/Theme_marco/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="<?= $dataProvider->get("request-uri") ?>assets/Theme_marco/css/styles_1.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?= $dataProvider->get("request-uri") ?>assets/Theme_marco/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
