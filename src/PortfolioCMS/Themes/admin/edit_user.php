    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title text-center"><strong><i class="fa fa-edit"></i> &nbsp; Gebruiker bewerken</strong>
                        </h4>
                        <hr class="style-one"/>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        <form class="form-custom float-left" action="" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-custom">Bewerk gebruiker</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
