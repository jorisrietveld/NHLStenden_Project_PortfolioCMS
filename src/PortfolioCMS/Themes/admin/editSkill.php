<!doctype html>
<?php
$page_title = 'Vaardigheid aanpassen | Admin';
$pageName = 'portfolio';
include 'header.php';
?>
<body>
                ...
                <div class="card">
                    <div class="header">
                        <h4 class="title text-center">
                            <strong>
                                <i class="fa fa-pencil-square-o"></i> Vaardigheid aanpassen
                            </strong>
                        </h4>
                        <hr class="style-one"/>
                                        ...
                                        <form class="form-custom float-left" action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       class="form-control"
                                                       id="skill"
                                                       value="<?= $dataProvider->call('skill-data','getName') ?>"
                                                       required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       class="form-control"
                                                       id="level"
                                                       value="<?= $dataProvider->call('skill-data','getLevelOfExperience') ?>"
                                                       required>
                                            </div>
