...
CREATE TABLE IF NOT EXISTS `User` (
  ...
  `userId`         INT UNSIGNED UNIQUE AUTO_INCREMENT                             NOT NULL, # The unique identification code of the record.
...
CREATE TABLE IF NOT EXISTS `Student` (
  ...
  `address`     VARBINARY(255)        NOT NULL, # The encrypted name of the address where the student lives.
  ...
  CONSTRAINT fk_student_user FOREIGN KEY `Student`(`userId`) REFERENCES `DigitalPortfolio`.`User` (`userId`)
...
CREATE TABLE IF NOT EXISTS `Teacher` (
  ...
  CONSTRAINT fk_teacher_user FOREIGN KEY `Teacher`(`userId`) REFERENCES `DigitalPortfolio`.`User` (`userId`)
...
CREATE TABLE IF NOT EXISTS `GuestBookMessage` (
  ...
  `messageId` INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_guestBook PRIMARY KEY `GuestBookMessage`(`messageId`),
...
CREATE TABLE IF NOT EXISTS `Theme` (
  ...
  `themeId`       INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_theme PRIMARY KEY `Theme`(`themeId`)
...
CREATE TABLE IF NOT EXISTS `Page` (
  ...
  `pageId`      INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_page PRIMARY KEY `Page`(`pageId`),



  # Constraint to define the foreign key to Theme( id )

  CONSTRAINT fk_page_theme FOREIGN KEY `Page`(`themeId`) REFERENCES `DigitalPortfolio`.`Theme` (`themeId`)
...
CREATE TABLE IF NOT EXISTS `Portfolio` (
  ...
  `portfolioId`      INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_portfolio PRIMARY KEY `Portfolio`(`portfolioId`),



  # Constraint to define the foreign key to User( id )

  CONSTRAINT fk_portfolio_user FOREIGN KEY `Portfolio`(`userId`) REFERENCES `DigitalPortfolio`.`User` (`userId`)
  ...
  CONSTRAINT fk_portfolio_theme FOREIGN KEY `Portfolio`(`themeId`) REFERENCES `DigitalPortfolio`.`Theme` (`themeId`)
...
CREATE TABLE IF NOT EXISTS `JobExperience` (
  ...
  `jobId`        INT UNSIGNED UNIQUE  AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_jobExperience PRIMARY KEY `JobExperience`(`jobId`),



  # Constraint to define the foreign key to the entity Portfolio( id )

  CONSTRAINT fk_jobExperience_portfolio FOREIGN KEY `JobExperience`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
...
CREATE TABLE IF NOT EXISTS `Language` (
  ...
  `languageId`  INT UNSIGNED UNIQUE AUTO_INCREMENT    NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_language PRIMARY KEY `Language`(`languageId`),



  # Constraint to define the foreign key to the entity Portfolio( id )

  CONSTRAINT fk_language_portfolio FOREIGN KEY `Language`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
...
CREATE TABLE IF NOT EXISTS `Training` (
  ...
  `trainingId`                  INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_training PRIMARY KEY `Training`(`trainingId`),



  # Constraint to define the foreign key to the entity Portfolio( id )

  CONSTRAINT fk_training_portfolio FOREIGN KEY `Training`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
...
CREATE TABLE IF NOT EXISTS `UploadedFile` (
  ...
  `uploadedFileId` INT UNSIGNED UNIQUE NOT NULL AUTO_INCREMENT, # The unique identification code of the record.
  ...
  CONSTRAINT pk_uploadedFile PRIMARY KEY `UploadedFile.`(`uploadedFileId`),



  # Constraint to define the foreign key to the entity Portfolio( id )

  CONSTRAINT fk_uploadedFile_portfolio FOREIGN KEY `UploadedFile`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
...
CREATE TABLE IF NOT EXISTS `SLBAssignment` (
  ...
  CONSTRAINT fk_slbAssignment_uploadedFile FOREIGN KEY `SLBAssignment`(`uploadedFileId`) REFERENCES `DigitalPortfolio`.`UploadedFile` (`uploadedFileId`)
...
CREATE TABLE IF NOT EXISTS `Image` (
  ...
  CONSTRAINT fk_image_uploadedFile FOREIGN KEY `Image`(`uploadedFileId`) REFERENCES `DigitalPortfolio`.`UploadedFile` (`uploadedFileId`)
...
CREATE TABLE IF NOT EXISTS `Skill` (
  ...
  `skillId`           INT UNSIGNED UNIQUE AUTO_INCREMENT, # The unique identification code of the record.
  ...
  CONSTRAINT pk_uploadedFile PRIMARY KEY `Skill`(`skillId`),



  # Constraint to define the foreign key to the entity Portfolio( id )

  CONSTRAINT fk_skill_portfolio FOREIGN KEY `Skill`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
...
CREATE TABLE IF NOT EXISTS `Hobby` (
  ...
  `hobbyId`          INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  CONSTRAINT pk_uploadedFile PRIMARY KEY `Hobby`(`hobbyId`),



  # Constraint to define the foreign key to the entity Portfolio( id )

  CONSTRAINT fk_hobby_portfolio FOREIGN KEY `Hobby`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
...
CREATE TABLE IF NOT EXISTS `Project` (
  ...
  `projectId`        INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, # The unique identification code of the record.
  ...
  `uploadedFileId`   INT UNSIGNED                       NOT NULL, # The unique identifier of the uploaded image thumbnail that belongs to the project.
  ...
  CONSTRAINT pk_project PRIMARY KEY `Project`(`projectId`),



  # Constraint to define the foreign key to the entity Image( id )

  CONSTRAINT fk_project_image FOREIGN KEY `Project`(`UploadedFileId`) REFERENCES `DigitalPortfolio`.`Image` (`uploadedFileId`)
  ...
  CONSTRAINT fk_project_portfolio FOREIGN KEY `Project`(`portfolioId`) REFERENCES `DigitalPortfolio`.`Portfolio` (`portfolioId`)
