...
VALUES ( 'home', 'index.php', 'De portefolio pagina', '/index', LAST_INSERT_ID() );
COMMIT;
...
INSERT INTO `DigitalPortfolio`.`Page`(name, fileName, description, url, themeId)
VALUES ( 'home', 'index.php', 'De portefolio pagina', '/index', @portfolioId );

INSERT INTO `DigitalPortfolio`.`Page`(name, fileName, description, url, themeId)
VALUES ( 'projecten', 'projecten.php', 'De projecten pagina', '/projects', @portfolioId );

INSERT INTO `DigitalPortfolio`.`Page`(name, fileName, description, url, themeId)
VALUES ( 'gastenboek', 'guestbook.php', 'De gastenboek pagina', '/guestbook', @portfolioId );

INSERT INTO `DigitalPortfolio`.`Page`(name, fileName, description, url, themeId)
VALUES ( 'slb opdrachten', 'slbOpdrachten.php', 'De slbOpdrachten pagina', '/slb_assignments', @portfolioId );
COMMIT;
